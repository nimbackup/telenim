...
# Generated on 2020-12-25T17:38:17+03:00
# td_api.tl sha1sum - a17c9aaa61e80a1bf71d0d850af4e5baa9800bbd
# Git hash - 29c7e786178919e60e96e1dbcc9aa142f0aedf1c
...
type
  ...
  AnimatedChatPhoto* = object
    ...
    kind {.jsonName: "@type".}: string
    length* {.jsonName: "length".}: int32 ## Animation width and height
    file* {.jsonName: "file".}: File ## Information about the animation file
    mainFrameTimestamp* {.jsonName: "main_frame_timestamp".}: float ## Timestamp of the frame, used as a static chat photo
  ...
  RecommendedChatFilter* = object
    ## Describes a recommended chat filter
    kind {.jsonName: "@type".}: string
    filter* {.jsonName: "filter".}: ChatFilter ## The chat filter
    description* {.jsonName: "description".}: string ## Describes a recommended chat filter
  ...
  SuggestedActionKind* {.pure.} = enum
    saCheckPhoneNumber = "suggestedActionCheckPhoneNumber",
    saEnableArchiveAndMuteNewChats = "suggestedActionEnableArchiveAndMuteNewChats",

  SuggestedAction* = object
    ## Describes an action suggested to the current user
    case kind* {.jsonName: "@type".}: SuggestedActionKind
    of saEnableArchiveAndMuteNewChats:
      ## Suggests the user to enable "archive_and_mute_new_chats_from_unknown_users" option
      discard
    of saCheckPhoneNumber:
  ...
  Call* = object
    ...
    isVideo* {.jsonName: "is_video".}: bool ## True, if the call is a video call
  ...
  FoundMessages* = object
    ...
    kind {.jsonName: "@type".}: string
    totalCount* {.jsonName: "total_count".}: int32 ## Approximate total count of messages found; -1 if unknown
  ...
  ChatPhotos* = object
    ...
    kind {.jsonName: "@type".}: string
    totalCount* {.jsonName: "total_count".}: int32 ## Total number of photos
    photos* {.jsonName: "photos".}: seq[ChatPhoto] ## List of photos
  ...
  MessageSenders* = object
    ...
    kind {.jsonName: "@type".}: string
    totalCount* {.jsonName: "total_count".}: int32 ## Approximate total count of messages senders found
    senders* {.jsonName: "senders".}: seq[MessageSender] ## List of message senders

  ChatMembersFilterKind* {.pure.} = enum
    cmfBanned = "chatMembersFilterBanned",
    cmfMembers = "chatMembersFilterMembers",
    cmfMention = "chatMembersFilterMention",
  ...
  ChatMembersFilter* = object
    ...
    of cmfMention:
      ...
      chatmembersfiltermentiMessageThreadId* {.jsonName: "message_thread_id".}: int64 ## If non-zero, the identifier of the current message thread
    of cmfRestricted:
  ...
  DiceStickersKind* {.pure.} = enum
    dsSlotMachine = "diceStickersSlotMachine",
    dsRegular = "diceStickersRegular",

  DiceStickers* = object
    ## Contains animated stickers which should be used for dice animation rendering
    case kind* {.jsonName: "@type".}: DiceStickersKind
    of dsRegular:
      ## A regular animated sticker
      dicestickersregulSticker* {.jsonName: "sticker".}: Sticker ## The animated sticker with the dice animation
    of dsSlotMachine:
      ## Animated stickers to be combined into a slot machine
      smBackground* {.jsonName: "background".}: Sticker ## The animated sticker with the slot machine background. The background animation must start playing after all reel animations finish
      smLever* {.jsonName: "lever".}: Sticker ## The animated sticker with the lever animation. The lever animation must play once in the initial dice state
      smLeftReel* {.jsonName: "left_reel".}: Sticker ## The animated sticker with the left reel
      smCenterReel* {.jsonName: "center_reel".}: Sticker ## The animated sticker with the center reel
      smRightReel* {.jsonName: "right_reel".}: Sticker ## The animated sticker with the right reel
  ...
  TdlibParameters* = object
    ...
    systemVersion* {.jsonName: "system_version".}: string ## Version of the operating system the application is being run on. If empty, the version is automatically detected by TDLib
  ...
  Photo* = object
    ## Describes a photo
    kind {.jsonName: "@type".}: string
    hasStickers* {.jsonName: "has_stickers".}: bool ## True, if stickers were added to the photo. The list of corresponding sticker sets can be received using getAttachedStickerSets
  ...
  ChatList* = object
    ...
    of clFilter:
      ...
      chatlistfiltChatFilterId* {.jsonName: "chat_filter_id".}: int32 ## Chat filter identifier

  PhoneNumberInfo* = object
    ## Contains information about a phone number
    kind {.jsonName: "@type".}: string
    country* {.jsonName: "country".}: Option[CountryInfo] ## Information about the country to which the phone number belongs; may be null
    countryCallingCode* {.jsonName: "country_calling_code".}: string ## The part of the phone number denoting country calling code or its part
    formattedPhoneNumber* {.jsonName: "formatted_phone_number".}: string ## The phone number without country calling code formatted accordingly to local rules
  ...
  MessageLink* = object
    ...
    isPublic* {.jsonName: "is_public".}: bool ## True, if the link will work for non-members of the chat
  ...
  MessageForwardOriginKind* {.pure.} = enum
    ...
    mfoChat = "messageForwardOriginChat",
  ...
  MessageForwardOrigin* = object
    ...
    of mfoChat:
      ...
      messageforwardoriginchSenderChatId* {.jsonName: "sender_chat_id".}: int64 ## Identifier of the chat that originally sent the message
      messageforwardoriginchAuthorSignature* {.jsonName: "author_signature".}: string ## Original message author signature
    of mfoHiddenUser:
    ...
    of mfoChannel:
      ...
      messageforwardoriginchannMessageId* {.jsonName: "message_id".}: int64 ## Message identifier of the original message
  ...
  Supergroup* = object
    ...
    memberCount* {.jsonName: "member_count".}: int32 ## Number of members in the supergroup or channel; 0 if unknown. Currently it is guaranteed to be known only if the supergroup or channel was received through searchPublicChats, searchChatsNearby, getInactiveSupergroupChats, getSuitableDiscussionChats, getGroupsInCommon, or getUserPrivacySettingRules
  ...
  CallServer* = object
    ...
    kind {.jsonName: "@type".}: string
    id* {.jsonName: "id".}: string ## Server identifier
    ipAddress* {.jsonName: "ip_address".}: string ## Server IPv4 address
    ipv6Address* {.jsonName: "ipv6_address".}: string ## Server IPv6 address
    port* {.jsonName: "port".}: int32 ## Server port number
    typ* {.jsonName: "type".}: CallServerType ## Server type
  ...
  Sticker* = object
    ...
    thumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Sticker thumbnail in WEBP or JPEG format; may be null
  ...
  Animation* = object
    ...
    hasStickers* {.jsonName: "has_stickers".}: bool ## True, if stickers were added to the animation. The list of corresponding sticker set can be received using getAttachedStickerSets
    minithumbnail* {.jsonName: "minithumbnail".}: Option[Minithumbnail] ## Animation minithumbnail; may be null
    thumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Animation thumbnail in JPEG or MPEG4 format; may be null
  ...
  Poll* = object
    ...
    question* {.jsonName: "question".}: string ## Poll question, 1-300 characters
  ...
  MessageThreadInfo* = object
    ...
    kind {.jsonName: "@type".}: string
    chatId* {.jsonName: "chat_id".}: int64 ## Identifier of the chat to which the message thread belongs
    messageThreadId* {.jsonName: "message_thread_id".}: int64 ## Message thread identifier, unique within the chat
    replyInfo* {.jsonName: "reply_info".}: MessageReplyInfo ## Contains information about the message thread
    messages* {.jsonName: "messages".}: seq[Message] ## The messages from which the thread starts. The messages are returned in a reverse chronological order (i.e., in order of decreasing message_id)
    draftMessage* {.jsonName: "draft_message".}: Option[DraftMessage] ## A draft of a message in the message thread; may be null
  ...
  Chat* = object
    ...
    photo* {.jsonName: "photo".}: Option[ChatPhotoInfo] ## Chat photo; may be null
    ...
    positions* {.jsonName: "positions".}: seq[ChatPosition] ## Positions of the chat in chat lists
    isMarkedAsUnread* {.jsonName: "is_marked_as_unread".}: bool ## True, if the chat is marked as unread
    isBlocked* {.jsonName: "is_blocked".}: bool ## True, if the chat is blocked by the current user and private messages from the chat can't be received
    ...
    clientData* {.jsonName: "client_data".}: string ## Contains application-specific data associated with the chat. (For example, the chat scroll position or local chat notification settings can be stored here.) Persistent if the message database is used
  ...
  StickerSetInfo* = object
    ...
    thumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Sticker set thumbnail in WEBP or TGS format with width and height 100; may be null
    ...
    covers* {.jsonName: "covers".}: seq[Sticker] ## Contains up to the first 5 stickers from the set, depending on the context. If the application needs more stickers the full set should be requested
  ...
  PassportAuthorizationForm* = object
    ...
    requiredElements* {.jsonName: "required_elements".}: seq[PassportRequiredElement] ## Information about the Telegram Passport elements that must be provided to complete the form
  ...
  MessageSenderKind* {.pure.} = enum
    msUser = "messageSenderUser",
    msChat = "messageSenderChat",

  MessageSender* = object
    ## Contains information about the sender of a message
    case kind* {.jsonName: "@type".}: MessageSenderKind
    of msUser:
      ## The message was sent by a known user
      messagesenderusUserId* {.jsonName: "user_id".}: int32 ## Identifier of the user that sent the message
    of msChat:
      ## The message was sent on behalf of a chat
      messagesenderchChatId* {.jsonName: "chat_id".}: int64 ## Identifier of the chat that sent the message

  CallServerTypeKind* {.pure.} = enum
    cstWebrtc = "callServerTypeWebrtc",
    cstTelegramReflector = "callServerTypeTelegramReflector",

  CallServerType* = object
    ## Describes the type of a call server
    case kind* {.jsonName: "@type".}: CallServerTypeKind
    of cstTelegramReflector:
      ## A Telegram call reflector
      trPeerTag* {.jsonName: "peer_tag".}: string ## A peer tag to be used with the reflector
    of cstWebrtc:
      ## A WebRTC server
      callservertypewebrUsername* {.jsonName: "username".}: string ## Username to be used for authentication
      callservertypewebrPassword* {.jsonName: "password".}: string ## Authentication password
      callservertypewebrSupportsTurn* {.jsonName: "supports_turn".}: bool ## True, if the server supports TURN
      callservertypewebrSupportsStun* {.jsonName: "supports_stun".}: bool ## True, if the server supports STUN
  ...
  ChatEventAction* = object
    ...
    of ceMessageUnpinned:
      ...
      emuMessage* {.jsonName: "message".}: Message ## Unpinned message
    of ceMemberJoined:
    ...
    of cePhotoChanged:
      ...
      epcOldPhoto* {.jsonName: "old_photo".}: Option[ChatPhoto] ## Previous chat photo value; may be null
      epcNewPhoto* {.jsonName: "new_photo".}: Option[ChatPhoto] ## New chat photo value; may be null
    of ceInvitesToggled:
  ...
  Message* = object
    ...
    sender* {.jsonName: "sender".}: MessageSender ## The sender of the message
    ...
    isPinned* {.jsonName: "is_pinned".}: bool ## True, if the message is pinned
    canBeEdited* {.jsonName: "can_be_edited".}: bool ## True, if the message can be edited. For live location and poll messages this fields shows whether editMessageLiveLocation or stopPoll can be used with this message by the application
    ...
    canGetStatistics* {.jsonName: "can_get_statistics".}: bool ## True, if the message statistics are available
    canGetMessageThread* {.jsonName: "can_get_message_thread".}: bool ## True, if the message thread info is available
    ...
    interactionInfo* {.jsonName: "interaction_info".}: Option[MessageInteractionInfo] ## Information about interactions with the message; may be null
    replyInChatId* {.jsonName: "reply_in_chat_id".}: int64 ## If non-zero, the identifier of the chat to which the replied message belongs; Currently, only messages in the Replies chat can have different reply_in_chat_id and chat_id
    ...
    messageThreadId* {.jsonName: "message_thread_id".}: int64 ## If non-zero, the identifier of the message thread the message belongs to; unique within the chat to which the message belongs
    ...
    authorSignature* {.jsonName: "author_signature".}: string ## For channel posts and anonymous group messages, optional author signature
  ...
  ChatFilter* = object
    ...
    kind {.jsonName: "@type".}: string
    title* {.jsonName: "title".}: string ## The title of the filter; 1-12 characters without line feeds
    iconName* {.jsonName: "icon_name".}: string ## The icon name for short filter representation. If non-empty, must be one of "All", "Unread", "Unmuted", "Bots", "Channels", "Groups", "Private", "Custom", "Setup", "Cat", "Crown", "Favorite", "Flower", "Game", "Home", "Love", "Mask", "Party", "Sport", "Study", "Trade", "Travel", "Work".
    pinnedChatIds* {.jsonName: "pinned_chat_ids".}: seq[int64] ## The chat identifiers of pinned chats in the filtered chat list
    includedChatIds* {.jsonName: "included_chat_ids".}: seq[int64] ## The chat identifiers of always included chats in the filtered chat list
    excludedChatIds* {.jsonName: "excluded_chat_ids".}: seq[int64] ## The chat identifiers of always excluded chats in the filtered chat list
    excludeMuted* {.jsonName: "exclude_muted".}: bool ## True, if muted chats need to be excluded
    excludeRead* {.jsonName: "exclude_read".}: bool ## True, if read chats need to be excluded
    excludeArchived* {.jsonName: "exclude_archived".}: bool ## True, if archived chats need to be excluded
    includeContacts* {.jsonName: "include_contacts".}: bool ## True, if contacts need to be included
    includeNonContacts* {.jsonName: "include_non_contacts".}: bool ## True, if non-contact users need to be included
    includeBots* {.jsonName: "include_bots".}: bool ## True, if bots need to be included
    includeGroups* {.jsonName: "include_groups".}: bool ## True, if basic groups and supergroups need to be included
    includeChannels* {.jsonName: "include_channels".}: bool ## True, if channels need to be included
  ...
  StatisticalGraphKind* {.pure.} = enum
    sgAsync = "statisticalGraphAsync",
    sgData = "statisticalGraphData",
    sgError = "statisticalGraphError",

  StatisticalGraph* = object
    ## Describes a statistical graph
    case kind* {.jsonName: "@type".}: StatisticalGraphKind
    of sgData:
      ## A graph data
      statisticalgraphdaJsonData* {.jsonName: "json_data".}: string ## Graph data in JSON format
      statisticalgraphdaZoomToken* {.jsonName: "zoom_token".}: string ## If non-empty, a token which can be used to receive a zoomed in graph
    of sgAsync:
      ## The graph data to be asynchronously loaded through getStatisticalGraph
      statisticalgraphasyToken* {.jsonName: "token".}: string ## The token to use for data loading
    of sgError:
      ## An error message to be shown to the user instead of the graph
      statisticalgrapherrErrorMessage* {.jsonName: "error_message".}: string ## The error message
  ...
  ChatStatisticsInviterInfo* = object
    ...
    addedMemberCount* {.jsonName: "added_member_count".}: int32 ## Number of new members invited by the user
  ...
  PushMessageContent* = object
    ...
    of pmcVoiceNote:
      ...
      nvnIsPinned* {.jsonName: "is_pinned".}: bool ## True, if the message is a pinned message with the specified content
    ...
    of pmcMediaAlbum:
      ...
      maHasAudios* {.jsonName: "has_audios".}: bool ## True, if the album has at least one audio file
      maHasDocuments* {.jsonName: "has_documents".}: bool ## True, if the album has at least one document
  ...
  RecommendedChatFilters* = object
    ## Contains a list of recommended chat filters
    kind {.jsonName: "@type".}: string
    chatFilters* {.jsonName: "chat_filters".}: seq[RecommendedChatFilter] ## List of recommended chat filters
  ...
  ChatMemberStatus* = object
    ...
    of cmsCreator:
      ...
      chatmemberstatuscreatIsAnonymous* {.jsonName: "is_anonymous".}: bool ## True, if the creator isn't shown in the chat member list and sends messages anonymously; applicable to supergroups only
    ...
    of cmsAdministrator:
      ...
      chatmemberstatusadministratIsAnonymous* {.jsonName: "is_anonymous".}: bool ## True, if the administrator isn't shown in the chat member list and sends messages anonymously; applicable to supergroups only
    of cmsMember:
  ...
  SecretChat* = object
    ...
    layer* {.jsonName: "layer".}: int32 ## Secret chat layer; determines features supported by the chat partner's application. Video notes are supported if the layer >= 66; nested text entities and underline and strikethrough entities are supported if the layer >= 101
  ...
  MessageContentKind* {.pure.} = enum
    ...
    mProximityAlertTriggered = "messageProximityAlertTriggered",
  ...
  MessageContent* = object
    ...
    of mLocation:
      ...
      messagelocatiLivePeriod* {.jsonName: "live_period".}: int32 ## Time relative to the message send date, for which the location can be updated, in seconds
      ...
      messagelocatiHeading* {.jsonName: "heading".}: int32 ## For live locations, a direction in which the location moves, in degrees; 1-360. If 0 the direction is unknown
      messagelocatiProximityAlertRadius* {.jsonName: "proximity_alert_radius".}: int32 ## For live locations, a maximum distance to another chat member for proximity alerts, in meters (0-100000). 0 if the notification is disabled. Available only for the message sender
    of mVenue:
    ...
    of mDice:
      ...
      messagediInitialState* {.jsonName: "initial_state".}: Option[DiceStickers] ## The animated stickers with the initial dice animation; may be null if unknown. updateMessageContent will be sent when the sticker became known
      messagediFinalState* {.jsonName: "final_state".}: Option[DiceStickers] ## The animated stickers with the final dice animation; may be null if unknown. updateMessageContent will be sent when the sticker became known
    ...
    of mCall:
      ...
      messagecaIsVideo* {.jsonName: "is_video".}: bool ## True, if the call was a video call
    ...
    of mChatChangePhoto:
      ...
      ccpPhoto* {.jsonName: "photo".}: ChatPhoto ## New chat photo
    of mChatDeletePhoto:
    ...
    of mProximityAlertTriggered:
      ## A user in the chat came within proximity alert range
      patTraveler* {.jsonName: "traveler".}: MessageSender ## The user or chat, which triggered the proximity alert
      patWatcher* {.jsonName: "watcher".}: MessageSender ## The user or chat, which subscribed for the proximity alert
      patDistance* {.jsonName: "distance".}: int32 ## The distance between the users
    of mUnsupported:
  ...
  Countries* = object
    ...
    kind {.jsonName: "@type".}: string
    countries* {.jsonName: "countries".}: seq[CountryInfo] ## The list of countries
  ...
  Venue* = object
    ...
    provider* {.jsonName: "provider".}: string ## Provider of the venue database; as defined by the sender. Currently only "foursquare" and "gplaces" (Google Places) need to be supported
  ...
  SearchMessagesFilterKind* {.pure.} = enum
    ...
    smfPinned = "searchMessagesFilterPinned",
  ...
  ThumbnailFormatKind* {.pure.} = enum
    tfGif = "thumbnailFormatGif",
    tfPng = "thumbnailFormatPng",
    tfWebp = "thumbnailFormatWebp",
    tfTgs = "thumbnailFormatTgs",
    tfMpeg4 = "thumbnailFormatMpeg4",
    tfJpeg = "thumbnailFormatJpeg",

  ThumbnailFormat* = object
    ## Describes format of the thumbnail
    case kind* {.jsonName: "@type".}: ThumbnailFormatKind
    of tfJpeg:
  ...
  MessageInteractionInfo* = object
    ...
    replyInfo* {.jsonName: "reply_info".}: Option[MessageReplyInfo] ## Contains information about direct or indirect replies to the message; may be null. Currently, available only in channels with a discussion supergroup and discussion supergroups for messages, which are not replies itself

  CountryInfo* = object
    ## Contains information about a country
    kind {.jsonName: "@type".}: string
    countryCode* {.jsonName: "country_code".}: string ## A two-letter ISO 3166-1 alpha-2 country code
    name* {.jsonName: "name".}: string ## Native name of the country
    englishName* {.jsonName: "english_name".}: string ## English name of the country
    isHidden* {.jsonName: "is_hidden".}: bool ## True, if the country should be hidden from the list of all countries
    callingCodes* {.jsonName: "calling_codes".}: seq[string] ## List of country calling codes
  ...
  UserFullInfo* = object
    ...
    kind {.jsonName: "@type".}: string
    photo* {.jsonName: "photo".}: Option[ChatPhoto] ## User profile photo; may be null
    isBlocked* {.jsonName: "is_blocked".}: bool ## True, if the user is blocked by the current user
    canBeCalled* {.jsonName: "can_be_called".}: bool ## True, if the user can be called
    supportsVideoCalls* {.jsonName: "supports_video_calls".}: bool ## True, if a video call can be created with the user
  ...
  MessageCopyOptions* = object
    ...
    kind {.jsonName: "@type".}: string
    sendCopy* {.jsonName: "send_copy".}: bool ## True, if content of the message needs to be copied without a link to the original message. Always true if the message is forwarded to a secret chat
    replaceCaption* {.jsonName: "replace_caption".}: bool ## True, if media caption of the message copy needs to be replaced. Ignored if send_copy is false
    newCaption* {.jsonName: "new_caption".}: FormattedText ## New message caption. Ignored if replace_caption is false
  ...
  ReplyMarkup* = object
    ...
    of rmShowKeyboard:
      ...
      skResizeKeyboard* {.jsonName: "resize_keyboard".}: bool ## True, if the application needs to resize the keyboard vertically
      skOneTime* {.jsonName: "one_time".}: bool ## True, if the application needs to hide the keyboard after use
  ...
  PhoneNumberAuthenticationSettings* = object
    ...
    allowSmsRetrieverApi* {.jsonName: "allow_sms_retriever_api".}: bool ## For official applications only. True, if the application can use Android SMS Retriever API (requires Google Play Services >= 10.2) to automatically receive the authentication code from the SMS. See https://developers.google.com/identity/sms-retriever/ for more details
  ...
  UpdateKind* {.pure.} = enum
    ...
    uSuggestedActions = "updateSuggestedActions",
    uNewCallSignalingData = "updateNewCallSignalingData",
    uBasicGroupFullInfo = "updateBasicGroupFullInfo",
    uMessageMentionRead = "updateMessageMentionRead",
    uChatFilters = "updateChatFilters",
    uCall = "updateCall",
    ...
    uMessageIsPinned = "updateMessageIsPinned",
    uMessageInteractionInfo = "updateMessageInteractionInfo",
    ...
    uAnimationSearchParameters = "updateAnimationSearchParameters",
    ...
    uChatIsBlocked = "updateChatIsBlocked",
    ...
    uChatPosition = "updateChatPosition",
  ...
  Update* = object
    ...
    of uMessageIsPinned:
      ...
      mipChatId* {.jsonName: "chat_id".}: int64 ## Chat identifier
      mipMessageId* {.jsonName: "message_id".}: int64 ## The message identifier
      mipIsPinned* {.jsonName: "is_pinned".}: bool ## True, if the message is pinned
    of uMessageInteractionInfo:
      ## The information about interactions with a message has changed
      miiChatId* {.jsonName: "chat_id".}: int64 ## Chat identifier
      miiMessageId* {.jsonName: "message_id".}: int64 ## Message identifier
      miiInteractionInfo* {.jsonName: "interaction_info".}: Option[MessageInteractionInfo] ## New information about interactions with the message; may be null
    ...
    of uChatPhoto:
      ...
      cpPhoto* {.jsonName: "photo".}: Option[ChatPhotoInfo] ## The new chat photo; may be null
    of uChatPermissions:
      ## Chat permissions was changed
      ncpChatId* {.jsonName: "chat_id".}: int64 ## Chat identifier
    ...
    of uChatLastMessage:
      ...
      clmPositions* {.jsonName: "positions".}: seq[ChatPosition] ## The new chat positions in the chat lists
    of uChatPosition:
      ## The position of a chat in a chat list has changed. Instead of this update updateChatLastMessage or updateChatDraftMessage might be sent
      nncpChatId* {.jsonName: "chat_id".}: int64 ## Chat identifier
      cpPosition* {.jsonName: "position".}: ChatPosition ## New chat position. If new order is 0, then the chat needs to be removed from the list
    ...
    of uChatIsBlocked:
      ...
      cibChatId* {.jsonName: "chat_id".}: int64 ## Chat identifier
      cibIsBlocked* {.jsonName: "is_blocked".}: bool ## New value of is_blocked
    ...
    of uChatDraftMessage:
      ...
      cdmPositions* {.jsonName: "positions".}: seq[ChatPosition] ## The new chat positions in the chat lists
    of uChatFilters:
      ## The list of chat filters or a chat filter has changed
      cfChatFilters* {.jsonName: "chat_filters".}: seq[ChatFilterInfo] ## The new list of chat filters
    ...
    of uUserChatAction:
      ...
      ucaMessageThreadId* {.jsonName: "message_thread_id".}: int64 ## If not 0, a message thread identifier in which the action was performed
    ...
    of uFileGenerationStart:
      ...
      fgsConversion* {.jsonName: "conversion".}: string ## String specifying the conversion applied to the original file. If conversion is "#url#" than original_path contains an HTTP/HTTPS URL of a file, which should be downloaded by the application
    of uFileGenerationStop:
      ## File generation is no longer needed
      ffgsGenerationId* {.jsonName: "generation_id".}: string ## Unique identifier for the generation process
    of uCall:
      ## New call was created or information about a call was updated
      updatecaCall* {.jsonName: "call".}: Call ## New data about a call
    of uNewCallSignalingData:
      ## New call signaling data arrived
      ncsdCallId* {.jsonName: "call_id".}: int32 ## The call identifier
      ncsdData* {.jsonName: "data".}: string ## The data
    ...
    of uAnimationSearchParameters:
      ## The parameters of animation search through GetOption("animation_search_bot_username") bot has changed
      aspProvider* {.jsonName: "provider".}: string ## Name of the animation search provider
      aspEmojis* {.jsonName: "emojis".}: seq[string] ## The new list of emojis suggested for searching
    of uSuggestedActions:
      ## The list of suggested to the user actions has changed
      saAddedActions* {.jsonName: "added_actions".}: seq[SuggestedAction] ## Added suggested actions
      saRemovedActions* {.jsonName: "removed_actions".}: seq[SuggestedAction] ## Removed suggested actions
    of uNewInlineQuery:
      ...
      niqUserLocation* {.jsonName: "user_location".}: Option[Location] ## User location; may be null
    ...
    of uNewChosenInlineResult:
      ...
      ncirUserLocation* {.jsonName: "user_location".}: Option[Location] ## User location; may be null
    ...
    of uNewCustomQuery:
      ...
      ncqsId* {.jsonName: "id".}: string ## The query identifier
  ...
  CallState* = object
    ...
    of csReady:
      ...
      callstatereaServers* {.jsonName: "servers".}: seq[CallServer] ## List of available call servers
  ...
  NotificationType* = object
    ...
    of ntnPushMessage:
      ...
      npmMessageId* {.jsonName: "message_id".}: int64 ## The message identifier. The message will not be available in the chat history, but the ID can be used in viewMessages, or as reply_to_message_id
      npmSender* {.jsonName: "sender".}: MessageSender ## The sender of the message. Corresponding user or chat may be inaccessible
      npmSenderName* {.jsonName: "sender_name".}: string ## Name of the sender
  ...
  ChatPermissions* = object
    ...
    canSendOtherMessages* {.jsonName: "can_send_other_messages".}: bool ## True, if the user can send animations, games, stickers, and dice and use inline bots. Implies can_send_messages permissions
  ...
  StatisticalValue* = object
    ...
    kind {.jsonName: "@type".}: string
    value* {.jsonName: "value".}: float ## The current value
  ...
  ChatFilterInfo* = object
    ## Contains basic information about a chat filter
    kind {.jsonName: "@type".}: string
    id* {.jsonName: "id".}: int32 ## Unique chat filter identifier
    title* {.jsonName: "title".}: string ## The title of the filter; 1-12 characters without line feeds
    iconName* {.jsonName: "icon_name".}: string ## The icon name for short filter representation. One of "All", "Unread", "Unmuted", "Bots", "Channels", "Groups", "Private", "Custom", "Setup", "Cat", "Crown", "Favorite", "Flower", "Game", "Home", "Love", "Mask", "Party", "Sport", "Study", "Trade", "Travel", "Work"
  ...
  ChatMember* = object
    ...
    joinedChatDate* {.jsonName: "joined_chat_date".}: int32 ## Point in time (Unix timestamp) when the user joined the chat
    status* {.jsonName: "status".}: ChatMemberStatus ## Status of the member in the chat
    botInfo* {.jsonName: "bot_info".}: Option[BotInfo] ## If the user is a bot, information about the bot; may be null. Can be null even for a bot if the bot is not the chat member
  ...
  AutoDownloadSettings* = object
    ...
    preloadLargeVideos* {.jsonName: "preload_large_videos".}: bool ## True, if the beginning of video files needs to be preloaded for instant playback
  ...
  MessageForwardInfo* = object
    ...
    fromChatId* {.jsonName: "from_chat_id".}: int64 ## For messages forwarded to the chat with the current user (Saved Messages), to the Replies bot chat, or to the channel's discussion group, the identifier of the chat from which the message was forwarded last time; 0 if unknown
    fromMessageId* {.jsonName: "from_message_id".}: int64 ## For messages forwarded to the chat with the current user (Saved Messages), to the Replies bot chat, or to the channel's discussion group, the identifier of the original message from which the new message was forwarded last time; 0 if unknown
  ...
  MessageReplyInfo* = object
    ...
    kind {.jsonName: "@type".}: string
    replyCount* {.jsonName: "reply_count".}: int32 ## Number of times the message was directly or indirectly replied
    recentRepliers* {.jsonName: "recent_repliers".}: seq[MessageSender] ## Recent repliers to the message; available in channels with a discussion supergroup
    lastReadInboxMessageId* {.jsonName: "last_read_inbox_message_id".}: int64 ## Identifier of the last read incoming reply to the message
    lastReadOutboxMessageId* {.jsonName: "last_read_outbox_message_id".}: int64 ## Identifier of the last read outgoing reply to the message
    lastMessageId* {.jsonName: "last_message_id".}: int64 ## Identifier of the last reply to the message
  ...
  InlineKeyboardButtonTypeKind* {.pure.} = enum
    ...
    ikbtCallbackWithPassword = "inlineKeyboardButtonTypeCallbackWithPassword",
  ...
  InlineKeyboardButtonType* = object
    ...
    of ikbtCallbackWithPassword:
      ## A button that asks for password of the current user and then sends a callback query to a bot
      cwpData* {.jsonName: "data".}: string ## Data to be sent to the bot via a callback query
    of ikbtCallbackGame:
  ...
  Thumbnail* = object
    ...
    kind {.jsonName: "@type".}: string
    format* {.jsonName: "format".}: ThumbnailFormat ## Thumbnail format
    width* {.jsonName: "width".}: int32 ## Thumbnail width
    height* {.jsonName: "height".}: int32 ## Thumbnail height
    file* {.jsonName: "file".}: File ## The thumbnail
  ...
  Video* = object
    ...
    fileName* {.jsonName: "file_name".}: string ## Original name of the file; as defined by the sender
    mimeType* {.jsonName: "mime_type".}: string ## MIME type of the file; as defined by the sender
    hasStickers* {.jsonName: "has_stickers".}: bool ## True, if stickers were added to the video. The list of corresponding sticker sets can be received using getAttachedStickerSets
    ...
    thumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Video thumbnail in JPEG or MPEG4 format; as defined by the sender; may be null
  ...
  StickerSet* = object
    ...
    title* {.jsonName: "title".}: string ## Title of the sticker set
    name* {.jsonName: "name".}: string ## Name of the sticker set
    thumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Sticker set thumbnail in WEBP or TGS format with width and height 100; may be null. The file can be downloaded only before the thumbnail is changed
  ...
  ChatStatisticsAdministratorActionsInfo* = object
    ...
    kind {.jsonName: "@type".}: string
    userId* {.jsonName: "user_id".}: int32 ## Administrator user identifier
    deletedMessageCount* {.jsonName: "deleted_message_count".}: int32 ## Number of messages deleted by the administrator
    bannedUserCount* {.jsonName: "banned_user_count".}: int32 ## Number of users banned by the administrator
    restrictedUserCount* {.jsonName: "restricted_user_count".}: int32 ## Number of users restricted by the administrator

  Chats* = object
    ## Represents a list of chats
    kind {.jsonName: "@type".}: string
    totalCount* {.jsonName: "total_count".}: int32 ## Approximate total count of chats found
    chatIds* {.jsonName: "chat_ids".}: seq[int64] ## List of chat identifiers

  MessageStatistics* = object
    ## A detailed statistics about a message
    kind {.jsonName: "@type".}: string
    messageInteractionGraph* {.jsonName: "message_interaction_graph".}: StatisticalGraph ## A graph containing number of message views and shares
  ...
  ChatInviteLinkInfo* = object
    ...
    kind {.jsonName: "@type".}: string
    chatId* {.jsonName: "chat_id".}: int64 ## Chat identifier of the invite link; 0 if the user has no access to the chat before joining
    accessibleFor* {.jsonName: "accessible_for".}: int32 ## If non-zero, the amount of time for which read access to the chat will remain available, in seconds
  ...
  LogStream* = object
    ...
    of lsFile:
      ...
      logstreamfiRedirectStderr* {.jsonName: "redirect_stderr".}: bool ## Pass true to additionally redirect stderr to the log file. Ignored on Windows
    of lsEmpty:
  ...
  ChatPhoto* = object
    ...
    kind {.jsonName: "@type".}: string
    id* {.jsonName: "id".}: string ## Unique photo identifier
    addedDate* {.jsonName: "added_date".}: int32 ## Point in time (Unix timestamp) when the photo has been added
    minithumbnail* {.jsonName: "minithumbnail".}: Option[Minithumbnail] ## Photo minithumbnail; may be null
    sizes* {.jsonName: "sizes".}: seq[PhotoSize] ## Available variants of the photo in JPEG format, in different size
    animation* {.jsonName: "animation".}: Option[AnimatedChatPhoto] ## Animated variant of the photo in MPEG4 format; may be null
  ...
  OptionValue* = object
    ...
    of ovInteger:
      ...
      optionvalueintegValue* {.jsonName: "value".}: string ## The value of the option
    of ovString:
  ...
  ChatStatisticsMessageSenderInfo* = object
    ...
    kind {.jsonName: "@type".}: string
    userId* {.jsonName: "user_id".}: int32 ## User identifier
    sentMessageCount* {.jsonName: "sent_message_count".}: int32 ## Number of sent messages
    averageCharacterCount* {.jsonName: "average_character_count".}: int32 ## Average number of characters in sent messages
  ...
  CallbackQueryPayloadKind* {.pure.} = enum
    ...
    cqpDataWithPassword = "callbackQueryPayloadDataWithPassword",
  ...
  CallbackQueryPayload* = object
    ...
    of cqpDataWithPassword:
      ## The payload for a callback button requiring password
      dwpPassword* {.jsonName: "password".}: string ## The password for the current user
      dwpData* {.jsonName: "data".}: string ## Data that was attached to the callback button
    of cqpGame:
  ...
  Location* = object
    ...
    horizontalAccuracy* {.jsonName: "horizontal_accuracy".}: float ## The estimated horizontal accuracy of the location, in meters; as defined by the sender. 0 if unknown
  ...
  ChatAction* = object
    ...
    of caUploadingVideoNote:
      ...
      uuvnProgress* {.jsonName: "progress".}: int32 ## Upload progress, as a percentage
    of caCancel:
  ...
  SupergroupFullInfo* = object
    ...
    canGetStatistics* {.jsonName: "can_get_statistics".}: bool ## True, if the supergroup or channel statistics are available
  ...
  PhotoSize* = object
    ...
    kind {.jsonName: "@type".}: string
    typ* {.jsonName: "type".}: string ## Image type (see https://core.telegram.org/constructor/photoSize)
    photo* {.jsonName: "photo".}: File ## Information about the image file
    width* {.jsonName: "width".}: int32 ## Image width
    height* {.jsonName: "height".}: int32 ## Image height
    progressiveSizes* {.jsonName: "progressive_sizes".}: seq[int32] ## Sizes of progressive JPEG file prefixes, which can be used to preliminarily show the image
  ...
  MessageLinkInfo* = object
    ...
    forComment* {.jsonName: "for_comment".}: bool ## True, if the message is linked as a channel post comment or from a message thread
  ...
  ChatLists* = object
    ...
    kind {.jsonName: "@type".}: string
    chatLists* {.jsonName: "chat_lists".}: seq[ChatList] ## List of chat lists
  ...
  ChatPosition* = object
    ...
    kind {.jsonName: "@type".}: string
    list* {.jsonName: "list".}: ChatList ## The chat list
    order* {.jsonName: "order".}: string ## A parameter used to determine order of the chat in the chat list. Chats must be sorted by the pair (order, chat.id) in descending order
    isPinned* {.jsonName: "is_pinned".}: bool ## True, if the chat is pinned in the chat list
    source* {.jsonName: "source".}: Option[ChatSource] ## Source of the chat in the chat list; may be null

  ProfilePhoto* = object
    ## Describes a user profile photo
    kind {.jsonName: "@type".}: string
    id* {.jsonName: "id".}: string ## Photo identifier; 0 for an empty photo. Can be used to find a photo in a list of user profile photos
    ...
    hasAnimation* {.jsonName: "has_animation".}: bool ## True, if the photo has animated variant
  ...
  ChatStatisticsMessageInteractionInfo* = object
  ...
  InlineQueryResult* = object
    ...
    of iqrArticle:
      ...
      inlinequeryresultarticThumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Result thumbnail in JPEG format; may be null
    of iqrContact:
      ## Represents a user contact
      ...
      inlinequeryresultcontaThumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Result thumbnail in JPEG format; may be null
    of iqrLocation:
      ## Represents a point on the map
      ...
      inlinequeryresultlocatiThumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Result thumbnail in JPEG format; may be null
    of iqrVenue:
      ## Represents information about a venue
      ...
      inlinequeryresultvenThumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Result thumbnail in JPEG format; may be null
    of iqrGame:
  ...
  ChatStatisticsKind* {.pure.} = enum
    csChannel = "chatStatisticsChannel",
    csSupergroup = "chatStatisticsSupergroup",

  ChatStatistics* = object
    ## Contains a detailed statistics about a chat
    case kind* {.jsonName: "@type".}: ChatStatisticsKind
    of csSupergroup:
      ## A detailed statistics about a supergroup chat
      chatstatisticssupergroPeriod* {.jsonName: "period".}: DateRange ## A period to which the statistics applies
      chatstatisticssupergroMemberCount* {.jsonName: "member_count".}: StatisticalValue ## Number of members in the chat
      chatstatisticssupergroMessageCount* {.jsonName: "message_count".}: StatisticalValue ## Number of messages sent to the chat
      chatstatisticssupergroViewerCount* {.jsonName: "viewer_count".}: StatisticalValue ## Number of users who viewed messages in the chat
      chatstatisticssupergroSenderCount* {.jsonName: "sender_count".}: StatisticalValue ## Number of users who sent messages to the chat
      chatstatisticssupergroMemberCountGraph* {.jsonName: "member_count_graph".}: StatisticalGraph ## A graph containing number of members in the chat
      chatstatisticssupergroJoinGraph* {.jsonName: "join_graph".}: StatisticalGraph ## A graph containing number of members joined and left the chat
      chatstatisticssupergroJoinBySourceGraph* {.jsonName: "join_by_source_graph".}: StatisticalGraph ## A graph containing number of new member joins per source
      chatstatisticssupergroLanguageGraph* {.jsonName: "language_graph".}: StatisticalGraph ## A graph containing distribution of active users per language
      chatstatisticssupergroMessageContentGraph* {.jsonName: "message_content_graph".}: StatisticalGraph ## A graph containing distribution of sent messages by content type
      chatstatisticssupergroActionGraph* {.jsonName: "action_graph".}: StatisticalGraph ## A graph containing number of different actions in the chat
      chatstatisticssupergroDayGraph* {.jsonName: "day_graph".}: StatisticalGraph ## A graph containing distribution of message views per hour
      chatstatisticssupergroWeekGraph* {.jsonName: "week_graph".}: StatisticalGraph ## A graph containing distribution of message views per day of week
      chatstatisticssupergroTopSenders* {.jsonName: "top_senders".}: seq[ChatStatisticsMessageSenderInfo] ## List of users sent most messages in the last week
      chatstatisticssupergroTopAdministrators* {.jsonName: "top_administrators".}: seq[ChatStatisticsAdministratorActionsInfo] ## List of most active administrators in the last week
      chatstatisticssupergroTopInviters* {.jsonName: "top_inviters".}: seq[ChatStatisticsInviterInfo] ## List of most active inviters of new members in the last week
    of csChannel:
      ## A detailed statistics about a channel chat
      chatstatisticschannPeriod* {.jsonName: "period".}: DateRange ## A period to which the statistics applies
      chatstatisticschannMemberCount* {.jsonName: "member_count".}: StatisticalValue ## Number of members in the chat
      chatstatisticschannMeanViewCount* {.jsonName: "mean_view_count".}: StatisticalValue ## Mean number of times the recently sent messages was viewed
      chatstatisticschannMeanShareCount* {.jsonName: "mean_share_count".}: StatisticalValue ## Mean number of times the recently sent messages was shared
      chatstatisticschannEnabledNotificationsPercentage* {.jsonName: "enabled_notifications_percentage".}: float ## A percentage of users with enabled notifications for the chat
      chatstatisticschannMemberCountGraph* {.jsonName: "member_count_graph".}: StatisticalGraph ## A graph containing number of members in the chat
      chatstatisticschannJoinGraph* {.jsonName: "join_graph".}: StatisticalGraph ## A graph containing number of members joined and left the chat
      chatstatisticschannMuteGraph* {.jsonName: "mute_graph".}: StatisticalGraph ## A graph containing number of members muted and unmuted the chat
      chatstatisticschannViewCountByHourGraph* {.jsonName: "view_count_by_hour_graph".}: StatisticalGraph ## A graph containing number of message views in a given hour in the last two weeks
      chatstatisticschannViewCountBySourceGraph* {.jsonName: "view_count_by_source_graph".}: StatisticalGraph ## A graph containing number of message views per source
      chatstatisticschannJoinBySourceGraph* {.jsonName: "join_by_source_graph".}: StatisticalGraph ## A graph containing number of new member joins per source
      chatstatisticschannLanguageGraph* {.jsonName: "language_graph".}: StatisticalGraph ## A graph containing number of users viewed chat messages per language
      chatstatisticschannMessageInteractionGraph* {.jsonName: "message_interaction_graph".}: StatisticalGraph ## A graph containing number of chat message views and shares
      chatstatisticschannInstantViewInteractionGraph* {.jsonName: "instant_view_interaction_graph".}: StatisticalGraph ## A graph containing number of views of associated with the chat instant views
      chatstatisticschannRecentMessageInteractions* {.jsonName: "recent_message_interactions".}: seq[ChatStatisticsMessageInteractionInfo] ## Detailed statistics about number of views and shares of recently sent messages
  ...
  ChatActionBar* = object
    ...
    of cabReportSpam:
      ...
      rsCanUnarchive* {.jsonName: "can_unarchive".}: bool ## If true, the chat was automatically archived and can be moved back to the main chat list using addChatToList simultaneously with setting chat notification settings to default using setChatNotificationSettings
    ...
    of cabReportAddBlock:
      ...
      rabCanUnarchive* {.jsonName: "can_unarchive".}: bool ## If true, the chat was automatically archived and can be moved back to the main chat list using addChatToList simultaneously with setting chat notification settings to default using setChatNotificationSettings
      rabDistance* {.jsonName: "distance".}: int32 ## If non-negative, the current user was found by the peer through searchChatsNearby and this is the distance between the users
    of cabAddContact:
  ...
  Document* = object
    ...
    thumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Document thumbnail in JPEG or PNG format (PNG will be used only for background patterns); as defined by the sender; may be null
    document* {.jsonName: "document".}: File ## File containing the document

  ChatPhotoInfo* = object
    ## Contains basic information about the photo of a chat
    kind {.jsonName: "@type".}: string
    small* {.jsonName: "small".}: File ## A small (160x160) chat photo variant in JPEG format. The file can be downloaded only before the photo is changed
    big* {.jsonName: "big".}: File ## A big (640x640) chat photo variant in JPEG format. The file can be downloaded only before the photo is changed
    hasAnimation* {.jsonName: "has_animation".}: bool ## True, if the photo has animated variant

  InputChatPhotoKind* {.pure.} = enum
    icpStatic = "inputChatPhotoStatic",
    icpAnimation = "inputChatPhotoAnimation",
    icpPrevious = "inputChatPhotoPrevious",

  InputChatPhoto* = object
    ## Describes a photo to be set as a user profile or chat photo
    case kind* {.jsonName: "@type".}: InputChatPhotoKind
    of icpPrevious:
      ## A previously used profile photo of the current user
      inputchatphotoprevioChatPhotoId* {.jsonName: "chat_photo_id".}: string ## Identifier of the profile photo to reuse
    of icpStatic:
      ## A static photo in JPEG format
      inputchatphotostatPhoto* {.jsonName: "photo".}: InputFile ## Photo to be set as profile photo. Only inputFileLocal and inputFileGenerated are allowed
    of icpAnimation:
      ## An animation in MPEG4 format; must be square, at most 10 seconds long, have width between 160 and 800 and be at most 2MB in size
      inputchatphotoanimatiAnimation* {.jsonName: "animation".}: InputFile ## Animation to be set as profile photo. Only inputFileLocal and inputFileGenerated are allowed
      inputchatphotoanimatiMainFrameTimestamp* {.jsonName: "main_frame_timestamp".}: float ## Timestamp of the frame, which will be used as static chat photo
  ...
  Audio* = object
    ...
    albumCoverThumbnail* {.jsonName: "album_cover_thumbnail".}: Option[Thumbnail] ## The thumbnail of the album cover in JPEG format; as defined by the sender. The full size thumbnail should be extracted from the downloaded file; may be null
  ...
  VideoNote* = object
    ...
    minithumbnail* {.jsonName: "minithumbnail".}: Option[Minithumbnail] ## Video minithumbnail; may be null
    thumbnail* {.jsonName: "thumbnail".}: Option[Thumbnail] ## Video thumbnail in JPEG format; as defined by the sender; may be null
    video* {.jsonName: "video".}: File ## File containing the video
  ...
  InputCredentials* = object
    ...
    of icApplePay:
      ...
      aapData* {.jsonName: "data".}: string ## JSON-encoded data with the credential identifier
  ...
  CallProblemKind* {.pure.} = enum
    cpPixelatedVideo = "callProblemPixelatedVideo",
    cpSilentLocal = "callProblemSilentLocal",
    cpDistortedVideo = "callProblemDistortedVideo",
  ...
  SupergroupMembersFilterKind* {.pure.} = enum
    ...
    smfMention = "supergroupMembersFilterMention",
  ...
  SupergroupMembersFilter* = object
    ...
    of SupergroupMembersFilterKind.smfMention:
      ## Returns users which can be mentioned in the supergroup
      supergroupmembersfiltermentiQuery* {.jsonName: "query".}: string ## Query to search for
      supergroupmembersfiltermentiMessageThreadId* {.jsonName: "message_thread_id".}: int64 ## If non-zero, the identifier of the current message thread
    of smfBots:
  ...
  UserType* = object
    ...
    of utBot:
      ...
      usertypebInlineQueryPlaceholder* {.jsonName: "inline_query_placeholder".}: string ## Placeholder for inline queries (displayed on the application input field)
  ...
  InputMessageContent* = object
    ...
    of imAnimation:
      ...
      maAddedStickerFileIds* {.jsonName: "added_sticker_file_ids".}: seq[int32] ## File identifiers of the stickers added to the animation, if applicable
    ...
    of imDocument:
      ...
      mdDisableContentTypeDetection* {.jsonName: "disable_content_type_detection".}: bool ## If true, automatic file type detection will be disabled and the document will be always sent as file. Always true for files sent to secret chats
    ...
    of imLocation:
      ...
      mlHeading* {.jsonName: "heading".}: int32 ## For live locations, a direction in which the location moves, in degrees; 1-360. Pass 0 if unknown
      mlProximityAlertRadius* {.jsonName: "proximity_alert_radius".}: int32 ## For live locations, a maximum distance to another chat member for proximity alerts, in meters (0-100000). Pass 0 if the notification is disabled. Can't be enabled in channels and Saved Messages
    of imVenue:
      ## A message with information about a venue
    ...
    of imPoll:
      ...
      mpQuestion* {.jsonName: "question".}: string ## Poll question, 1-255 characters (up to 300 characters for bots)
    ...
    of imForwarded:
      ...
      mfCopyOptions* {.jsonName: "copy_options".}: MessageCopyOptions ## Options to be used to copy content of the message without a link to the original message
  ...
  RichText* = ref object
    ...
    of rtReference:
      ...
      richtextreferenAnchorName* {.jsonName: "anchor_name".}: string ## The name of a richTextAnchor object, which is the first element of the target richTexts object
    ...
    of rtAnchorLink:
      ...
      alAnchorName* {.jsonName: "anchor_name".}: string ## The anchor name. If the name is empty, the link should bring back to top
  ...
  MessageSendOptions* = object
    ...
    kind {.jsonName: "@type".}: string
    disableNotification* {.jsonName: "disable_notification".}: bool ## Pass true to disable notification for the message
  ...
  NetworkStatistics* = object
    ...
    kind {.jsonName: "@type".}: string
    sinceDate* {.jsonName: "since_date".}: int32 ## Point in time (Unix timestamp) from which the statistics are collected
  ...
  PageBlock* = ref object
    ...
    of pbChatLink:
      ...
      clPhoto* {.jsonName: "photo".}: Option[ChatPhotoInfo] ## Chat photo; may be null
  ...
  TdlibFuture = ref object
    ...
    of tfChatFilterInfo: chatfilterinfo: ChatFilterInfo
    ...
    of tfPhoneNumberInfo: phonenumberinfo: PhoneNumberInfo
    of tfChats: chats: Chats
    of tfMessageStatistics: messagestatistics: MessageStatistics
    of tfMessageLink: messagelink: MessageLink
    ...
    of tfMessageThreadInfo: messagethreadinfo: MessageThreadInfo
    ...
    of tfStatisticalGraph: statisticalgraph: StatisticalGraph
    ...
    of tfChatFilter: chatfilter: ChatFilter
    of tfOk: ok: Ok
    ...
    of tfChatStatistics: chatstatistics: ChatStatistics
...
proc completeFut*(event: sink JsonNode) = 
  ...
  of tfChatFilterInfo:
    completedFut.chatfilterinfo = event.toCustom(ChatFilterInfo)
  ...
  of tfMessageSenders:
    completedFut.messagesenders = event.toCustom(MessageSenders)
  of tfText:
  ...
  of tfPhoneNumberInfo:
    completedFut.phonenumberinfo = event.toCustom(PhoneNumberInfo)
  of tfChats:
    completedFut.chats = event.toCustom(Chats)
  of tfMessageStatistics:
    completedFut.messagestatistics = event.toCustom(MessageStatistics)
  of tfMessageLink:
    completedFut.messagelink = event.toCustom(MessageLink)
  ...
  of tfMessageThreadInfo:
    completedFut.messagethreadinfo = event.toCustom(MessageThreadInfo)
  of tfProxy:
  ...
  of tfStatisticalGraph:
    completedFut.statisticalgraph = event.toCustom(StatisticalGraph)
  of tfMessages:
  ...
  of tfChatFilter:
    completedFut.chatfilter = event.toCustom(ChatFilter)
  of tfOk:
  ...
  of tfChatLists:
    completedFut.chatlists = event.toCustom(ChatLists)
  of tfChatEvents:
    completedFut.chatevents = event.toCustom(ChatEvents)
  of tfRecommendedChatFilters:
    completedFut.recommendedchatfilters = event.toCustom(RecommendedChatFilters)
  of tfHashtags:
  ...
  of tfCountries:
    completedFut.countries = event.toCustom(Countries)
  of tfChatInviteLink:
  ...
  of tfChatStatistics:
    completedFut.chatstatistics = event.toCustom(ChatStatistics)
...
proc getMessageThreadHistory*(client: TdlibClient, chatId: int64, messageId: int64, fromMessageId: int64, offset: int32, limit: int32): Future[Messages] {.async.} = 
...
proc unpinChatMessage*(client: TdlibClient, chatId: int64, messageId: int64): Future[Ok] {.async.} = 
...
proc getMarkdownText*(client: TdlibClient, text: FormattedText): Future[FormattedText] {.async.} = 
...
proc getChatFilter*(client: TdlibClient, chatFilterId: int32): Future[ChatFilter] {.async.} = 
  ...
  result = client.waitFut(tfChatFilter, chatfilter)
...
proc setLocation*(client: TdlibClient, location: Location): Future[Ok] {.async.} = 
...
proc getStatisticalGraph*(client: TdlibClient, chatId: int64, token: string, x: int64): Future[StatisticalGraph] {.async.} = 
  ...
  result = client.waitFut(tfStatisticalGraph, statisticalgraph)
...
proc addLocalMessage*(client: TdlibClient, chatId: int64, sender: MessageSender, replyToMessageId: int64, disableNotification: bool, inputMessageContent: InputMessageContent): Future[Message] {.async.} = 
...
proc editInlineMessageLiveLocation*(client: TdlibClient, inlineMessageId: string, replyMarkup: ReplyMarkup, location = none(Location), heading: int32, proximityAlertRadius: int32): Future[Ok] {.async.} = 
...
proc getBankCardInfo*(client: TdlibClient, bankCardNumber: string): Future[BankCardInfo] {.async.} = 
  ...
  result = client.waitFut(tfBankCardInfo, bankcardinfo)
...
proc getCountries*(client: TdlibClient): Future[Countries] {.async.} = 
  ## Returns information about existing countries. Can be called before authorization
  client.send %*{
    "@type": "getCountries" 
  }
  result = client.waitFut(tfCountries, countries)
...
proc getCallbackQueryMessage*(client: TdlibClient, chatId: int64, messageId: int64, callbackQueryId: string): Future[Message] {.async.} = 
...
proc searchMessages*(client: TdlibClient, chatList: ChatList, query: string, offsetDate: int32, offsetChatId: int64, offsetMessageId: int64, limit: int32, filter: SearchMessagesFilter, minDate: int32, maxDate: int32): Future[Messages] {.async.} = 
...
proc getMessageEmbeddingCode*(client: TdlibClient, chatId: int64, messageId: int64, forAlbum: bool): Future[Text] {.async.} = 
...
proc getMessageThread*(client: TdlibClient, chatId: int64, messageId: int64): Future[MessageThreadInfo] {.async.} = 
  ...
  result = client.waitFut(tfMessageThreadInfo, messagethreadinfo)
...
proc deleteChatFilter*(client: TdlibClient, chatFilterId: int32): Future[Ok] {.async.} = 
...
proc setChatPhoto*(client: TdlibClient, chatId: int64, photo: InputChatPhoto): Future[Ok] {.async.} = 
...
proc sendInlineQueryResultMessage*(client: TdlibClient, chatId: int64, messageThreadId: int64, replyToMessageId: int64, options: MessageSendOptions, queryId: string, resultId: string, hideViaBot: bool): Future[Message] {.async.} = 
...
proc getChatStatistics*(client: TdlibClient, chatId: int64, isDark: bool): Future[ChatStatistics] {.async.} = 
  ...
  result = client.waitFut(tfChatStatistics, chatstatistics)
...
proc addChatToList*(client: TdlibClient, chatId: int64, chatList: ChatList): Future[Ok] {.async.} = 
...
proc getBlockedMessageSenders*(client: TdlibClient, offset: int32, limit: int32): Future[MessageSenders] {.async.} = 
  ...
  result = client.waitFut(tfMessageSenders, messagesenders)
...
proc viewMessages*(client: TdlibClient, chatId: int64, messageThreadId: int64, messageIds: seq[int64], forceRead: bool): Future[Ok] {.async.} = 
...
proc getMessagePublicForwards*(client: TdlibClient, chatId: int64, messageId: int64, offset: string, limit: int32): Future[FoundMessages] {.async.} = 
...
proc parseMarkdown*(client: TdlibClient, text: FormattedText): Future[FormattedText] {.async.} = 
...
proc getPhoneNumberInfo*(client: TdlibClient, phoneNumberPrefix: string): Future[PhoneNumberInfo] {.async.} = 
  ...
  result = client.waitFut(tfPhoneNumberInfo, phonenumberinfo)
...
proc getMessageStatistics*(client: TdlibClient, chatId: int64, messageId: int64, isDark: bool): Future[MessageStatistics] {.async.} = 
  ...
  result = client.waitFut(tfMessageStatistics, messagestatistics)
...
proc toggleMessageSenderIsBlocked*(client: TdlibClient, sender: MessageSender, isBlocked: bool): Future[Ok] {.async.} = 
...
proc editMessageText*(client: TdlibClient, chatId: int64, messageId: int64, replyMarkup: JsonNode, inputMessageContent: JsonNode): Future[Message] {.async.} = 
...
proc blockMessageSenderFromReplies*(client: TdlibClient, messageId: int64, deleteMessage: bool, deleteAllMessages: bool, reportSpam: bool): Future[Ok] {.async.} = 
...
proc sendMessage*(client: TdlibClient, chatId: int64, messageThreadId: int64 = 0, replyToMessageId: int64, options: JsonNode, replyMarkup: JsonNode, inputMessageContent: JsonNode): Future[Message] {.async.} = 
...
proc pinChatMessage*(client: TdlibClient, chatId: int64, messageId: int64, disableNotification: bool, onlyForSelf: bool): Future[Ok] {.async.} = 
...
proc getChatFilterDefaultIconName*(client: TdlibClient, filter: ChatFilter): Future[Text] {.async.} = 
...
proc sendMessageAlbum*(client: TdlibClient, chatId: int64, messageThreadId: int64, replyToMessageId: int64, options: MessageSendOptions, inputMessageContents: seq[InputMessageContent]): Future[Messages] {.async.} = 
...
proc reorderChatFilters*(client: TdlibClient, chatFilterIds: seq[int32]): Future[Ok] {.async.} = 
...
proc getTrendingStickerSets*(client: TdlibClient, offset: int32, limit: int32): Future[StickerSets] {.async.} = 
...
proc optimizeStorage*(client: TdlibClient, size: int64, ttl: int32, count: int32, immunityDelay: int32, fileTypes: seq[FileType], chatIds: seq[int64], excludeChatIds: seq[int64], returnDeletedFileStatistics: bool, chatLimit: int32): Future[StorageStatistics] {.async.} = 
...
proc editMessageLiveLocation*(client: TdlibClient, chatId: int64, messageId: int64, replyMarkup: ReplyMarkup, location = none(Location), heading: int32, proximityAlertRadius: int32): Future[Message] {.async.} = 
...
proc searchSecretMessages*(client: TdlibClient, chatId: int64, query: string, offset: string, limit: int32, filter: SearchMessagesFilter): Future[FoundMessages] {.async.} = 
...
proc sendChatAction*(client: TdlibClient, chatId: int64, messageThreadId: int64, action: ChatAction): Future[Ok] {.async.} = 
...
proc editChatFilter*(client: TdlibClient, chatFilterId: int32, filter: ChatFilter): Future[ChatFilterInfo] {.async.} = 
  ...
  result = client.waitFut(tfChatFilterInfo, chatfilterinfo)
...
proc searchEmojis*(client: TdlibClient, text: string, exactMatch: bool, inputLanguageCodes: seq[string]): Future[Emojis] {.async.} = 
...
proc toggleChatIsPinned*(client: TdlibClient, chatList: ChatList, chatId: int64, isPinned: bool): Future[Ok] {.async.} = 
...
proc createChatFilter*(client: TdlibClient, filter: ChatFilter): Future[ChatFilterInfo] {.async.} = 
...
proc getMessageLink*(client: TdlibClient, chatId: int64, messageId: int64, forAlbum: bool, forComment: bool): Future[MessageLink] {.async.} = 
  ...
  result = client.waitFut(tfMessageLink, messagelink)
...
proc discardCall*(client: TdlibClient, callId: int32, isDisconnected: bool, duration: int32, isVideo: bool, connectionId: string): Future[Ok] {.async.} = 
  ## Discards a call
  ## **call_id** - Call identifier
...
proc setStickerSetThumbnail*(client: TdlibClient, userId: int32, name: string, thumbnail: InputFile): Future[StickerSet] {.async.} = 
...
proc setCommands*(client: TdlibClient, commands: seq[BotCommand]): Future[Ok] {.async.} = 
...
proc forwardMessages*(client: TdlibClient, chatId: int64, fromChatId: int64, messageIds: seq[int64], options: MessageSendOptions, sendCopy: bool, removeCaption: bool): Future[Messages] {.async.} = 
...
proc getChatListsToAddChat*(client: TdlibClient, chatId: int64): Future[ChatLists] {.async.} = 
  ...
  result = client.waitFut(tfChatLists, chatlists)
...
proc createCall*(client: TdlibClient, userId: int32, protocol: CallProtocol, isVideo: bool): Future[CallId] {.async.} = 
  ## Creates a new call
...
proc sendCallSignalingData*(client: TdlibClient, callId: int32, data: string): Future[Ok] {.async.} = 
...
proc unpinAllChatMessages*(client: TdlibClient, chatId: int64): Future[Ok] {.async.} = 
...
proc getRecommendedChatFilters*(client: TdlibClient): Future[RecommendedChatFilters] {.async.} = 
  ## Returns recommended chat filters for the current user
  client.send %*{
    "@type": "getRecommendedChatFilters" 
  }
  result = client.waitFut(tfRecommendedChatFilters, recommendedchatfilters)
...
proc getUserProfilePhotos*(client: TdlibClient, userId: int32, offset: int32, limit: int32): Future[ChatPhotos] {.async.} = 
  ...
  result = client.waitFut(tfChatPhotos, chatphotos)
...
proc setProfilePhoto*(client: TdlibClient, photo: InputChatPhoto): Future[Ok] {.async.} = 
...
proc hideSuggestedAction*(client: TdlibClient, action: SuggestedAction): Future[Ok] {.async.} = 
...
proc searchChatMessages*(client: TdlibClient, chatId: int64, query: string, sender: MessageSender, fromMessageId: int64, offset: int32, limit: int32, filter: SearchMessagesFilter, messageThreadId: int64): Future[Messages] {.async.} = 
...
proc setTdlibParameters*(client: TdlibClient, parameters: JsonNode): Future[Ok] {.async.} = 
...
proc setChatDraftMessage*(client: TdlibClient, chatId: int64, messageThreadId: int64, draftMessage = none(DraftMessage)): Future[Ok] {.async.} = 
...
proc textEntityTypeBankCardNumber*(): JsonNode = 
  result = %*{
...
proc animatedChatPhoto*(length: int32, file: File, mainFrameTimestamp: float): JsonNode = 
  result = %*{
...
proc recommendedChatFilter*(filter: ChatFilter, description: string): JsonNode = 
  result = %*{
...
proc suggestedActionEnableArchiveAndMuteNewChats*(): JsonNode = 
  result = %*{
    "@type": "suggestedActionEnableArchiveAndMuteNewChats"
  }

proc suggestedActionCheckPhoneNumber*(): JsonNode = 
  result = %*{
...
proc call*(id: int32, userId: int32, isOutgoing: bool, isVideo: bool, state: CallState): JsonNode = 
  result = %*{
    "@type": "call",
    "id": id,
    "user_id": userId,
...
proc bankCardInfo*(title: string, actions: seq[BankCardActionOpenUrl]): JsonNode = 
  result = %*{
    "@type": "bankCardInfo",
    "title": title,
    "actions": actions
...
proc foundMessages*(totalCount: int32, messages: seq[Message], nextOffset: string): JsonNode = 
  result = %*{
    "@type": "foundMessages",
    "total_count": totalCount,
    "messages": messages,
...
proc chatPhotos*(totalCount: int32, photos: seq[ChatPhoto]): JsonNode = 
  result = %*{
    "@type": "chatPhotos",
    "total_count": totalCount,
    "photos": photos
...
proc messageSenders*(totalCount: int32, senders: seq[MessageSender]): JsonNode = 
  result = %*{
    "@type": "messageSenders",
    "total_count": totalCount,
    "senders": senders
...
proc chatMembersFilterMention*(messageThreadId: int64): JsonNode = 
  result = %*{
...
proc diceStickersRegular*(sticker: Sticker): JsonNode = 
  result = %*{
    "@type": "diceStickersRegular",
    "sticker": sticker
  }

proc diceStickersSlotMachine*(background: Sticker, lever: Sticker, leftReel: Sticker, centerReel: Sticker, rightReel: Sticker): JsonNode = 
  result = %*{
...
proc chatListFilter*(chatFilterId: int32): JsonNode = 
  result = %*{
    "@type": "chatListFilter",
    "chat_filter_id": chatFilterId
  }

proc phoneNumberInfo*(countryCallingCode: string, formattedPhoneNumber: string, country = none(CountryInfo)): JsonNode = 
  result = %*{
...
proc inputInlineQueryResultAnimation*(id: string, title: string, thumbnailUrl: string, thumbnailMimeType: string, videoUrl: string, videoMimeType: string, videoDuration: int32, videoWidth: int32, videoHeight: int32, replyMarkup: ReplyMarkup, inputMessageContent: InputMessageContent): JsonNode = 
  result = %*{
...
proc messageLink*(link: string, isPublic: bool): JsonNode = 
  result = %*{
    "@type": "messageLink",
    "link": link,
    "is_public": isPublic
...
proc basicGroupFullInfo*(description: string, creatorUserId: int32, members: seq[ChatMember], inviteLink: string, photo = none(ChatPhoto)): JsonNode = 
  result = %*{
...
proc messageForwardOriginChat*(senderChatId: int64, authorSignature: string): JsonNode = 
  result = %*{
...
proc callServer*(id: string, ipAddress: string, ipv6Address: string, port: int32, typ: CallServerType): JsonNode = 
  result = %*{
    "@type": "callServer",
    "id": id,
...
proc sticker*(setId: string, width: int32, height: int32, emoji: string, isAnimated: bool, isMask: bool, sticker: File, thumbnail = none(Thumbnail), maskPosition = none(MaskPosition)): JsonNode = 
  result = %*{
    "@type": "sticker",
    "set_id": setId,
    "width": width,
...
proc animation*(duration: int32, width: int32, height: int32, fileName: string, mimeType: string, hasStickers: bool, animation: File, thumbnail = none(Thumbnail), minithumbnail = none(Minithumbnail)): JsonNode = 
  result = %*{
    "@type": "animation",
    "duration": duration,
    "width": width,
...
proc poll*(id: string, question: string, options: seq[PollOption], totalVoterCount: int32, recentVoterUserIds: seq[int32], isAnonymous: bool, typ: PollType, openPeriod: int32, closeDate: int32, isClosed: bool): JsonNode = 
  result = %*{
    "@type": "poll",
    "id": id,
    "question": question,
...
proc messageThreadInfo*(chatId: int64, messageThreadId: int64, replyInfo: MessageReplyInfo, messages: seq[Message], draftMessage = none(DraftMessage)): JsonNode = 
  result = %*{
...
proc chat*(id: int64, typ: ChatType, title: string, permissions: ChatPermissions, positions: seq[ChatPosition], isMarkedAsUnread: bool, isBlocked: bool, hasScheduledMessages: bool, canBeDeletedOnlyForSelf: bool, canBeDeletedForAllUsers: bool, canBeReported: bool, defaultDisableNotification: bool, unreadCount: int32, lastReadInboxMessageId: int64, lastReadOutboxMessageId: int64, unreadMentionCount: int32, notificationSettings: ChatNotificationSettings, replyMarkupMessageId: int64, clientData: string, draftMessage = none(DraftMessage), actionBar = none(ChatActionBar), lastMessage = none(Message), photo = none(ChatPhotoInfo)): JsonNode = 
  result = %*{
    "@type": "chat",
    "id": id,
    "type": typ,
...
proc stickerSetInfo*(id: string, title: string, name: string, isInstalled: bool, isArchived: bool, isOfficial: bool, isAnimated: bool, isMasks: bool, isViewed: bool, size: int32, covers: seq[Sticker], thumbnail = none(Thumbnail)): JsonNode = 
  result = %*{
    "@type": "stickerSetInfo",
    "id": id,
    "title": title,
...
proc draftMessage*(replyToMessageId: int64, date: int32, inputMessageText: InputMessageContent): JsonNode = 
  result = %*{
    "@type": "draftMessage",
    "reply_to_message_id": replyToMessageId,
    "date": date,
...
proc messageSenderUser*(userId: int32): JsonNode = 
  result = %*{
    "@type": "messageSenderUser",
    "user_id": userId
  }

proc messageSenderChat*(chatId: int64): JsonNode = 
  result = %*{
    "@type": "messageSenderChat",
    "chat_id": chatId
  }

proc callServerTypeTelegramReflector*(peerTag: string): JsonNode = 
  result = %*{
    "@type": "callServerTypeTelegramReflector",
    "peer_tag": peerTag
  }

proc callServerTypeWebrtc*(username: string, password: string, supportsTurn: bool, supportsStun: bool): JsonNode = 
  result = %*{
...
proc chatEventMessageUnpinned*(message: Message): JsonNode = 
  result = %*{
...
proc chatEventPhotoChanged*(newPhoto = none(ChatPhoto), oldPhoto = none(ChatPhoto)): JsonNode = 
  result = %*{
...
proc message*(id: int64, sender: MessageSender, chatId: int64, isOutgoing: bool, isPinned: bool, canBeEdited: bool, canBeForwarded: bool, canBeDeletedOnlyForSelf: bool, canBeDeletedForAllUsers: bool, canGetStatistics: bool, canGetMessageThread: bool, isChannelPost: bool, containsUnreadMention: bool, date: int32, editDate: int32, replyInChatId: int64, replyToMessageId: int64, messageThreadId: int64, ttl: int32, ttlExpiresIn: float, viaBotUserId: int32, authorSignature: string, mediaAlbumId: string, restrictionReason: string, content: MessageContent, replyMarkup = none(ReplyMarkup), interactionInfo = none(MessageInteractionInfo), forwardInfo = none(MessageForwardInfo), schedulingState = none(MessageSchedulingState), sendingState = none(MessageSendingState)): JsonNode = 
  result = %*{
    "@type": "message",
    "id": id,
    "sender": sender,
...
proc chatSourceMtprotoProxy*(): JsonNode = 
  result = %*{
    "@type": "chatSourceMtprotoProxy"
  }

proc chatSourcePublicServiceAnnouncement*(typ: string, text: string): JsonNode = 
  result = %*{
...
proc chatFilter*(title: string, iconName: string, pinnedChatIds: seq[int64], includedChatIds: seq[int64], excludedChatIds: seq[int64], excludeMuted: bool, excludeRead: bool, excludeArchived: bool, includeContacts: bool, includeNonContacts: bool, includeBots: bool, includeGroups: bool, includeChannels: bool): JsonNode = 
  result = %*{
    "@type": "chatFilter",
    "title": title,
    "icon_name": iconName,
...
proc statisticalGraphData*(jsonData: string, zoomToken: string): JsonNode = 
  result = %*{
...
proc statisticalGraphAsync*(token: string): JsonNode = 
  result = %*{
    "@type": "statisticalGraphAsync",
    "token": token
  }

proc statisticalGraphError*(errorMessage: string): JsonNode = 
  result = %*{
...
proc chatStatisticsInviterInfo*(userId: int32, addedMemberCount: int32): JsonNode = 
  result = %*{
...
proc pushMessageContentMediaAlbum*(totalCount: int32, hasPhotos: bool, hasVideos: bool, hasAudios: bool, hasDocuments: bool): JsonNode = 
  result = %*{
...
proc recommendedChatFilters*(chatFilters: seq[RecommendedChatFilter]): JsonNode = 
  result = %*{
    "@type": "recommendedChatFilters",
    "chat_filters": chatFilters
  }

proc chatMemberStatusCreator*(customTitle: string, isAnonymous: bool, isMember: bool): JsonNode = 
  result = %*{
...
proc chatMemberStatusAdministrator*(customTitle: string, canBeEdited: bool, canChangeInfo: bool, canPostMessages: bool, canEditMessages: bool, canDeleteMessages: bool, canInviteUsers: bool, canRestrictMembers: bool, canPinMessages: bool, canPromoteMembers: bool, isAnonymous: bool): JsonNode = 
  result = %*{
...
proc messageLocation*(location: Location, livePeriod: int32, expiresIn: int32, heading: int32, proximityAlertRadius: int32): JsonNode = 
  result = %*{
...
proc messageDice*(emoji: string, value: int32, successAnimationFrameNumber: int32, finalState = none(DiceStickers), initialState = none(DiceStickers)): JsonNode = 
  result = %*{
    "@type": "messageDice",
...
proc messageCall*(isVideo: bool, discardReason: CallDiscardReason, duration: int32): JsonNode = 
  result = %*{
    "@type": "messageCall",
    "is_video": isVideo,
...
proc messageChatChangePhoto*(photo: ChatPhoto): JsonNode = 
  result = %*{
...
proc messageProximityAlertTriggered*(traveler: MessageSender, watcher: MessageSender, distance: int32): JsonNode = 
  result = %*{
...
proc countries*(countries: seq[CountryInfo]): JsonNode = 
  result = %*{
    "@type": "countries",
    "countries": countries
  }
...
proc searchMessagesFilterFailedToSend*(): JsonNode = 
  result = %*{
    "@type": "searchMessagesFilterFailedToSend"
  }

proc searchMessagesFilterPinned*(): JsonNode = 
  result = %*{
    "@type": "searchMessagesFilterPinned"
  }

proc thumbnailFormatJpeg*(): JsonNode = 
  result = %*{
    "@type": "thumbnailFormatJpeg"
  }

proc thumbnailFormatPng*(): JsonNode = 
  result = %*{
    "@type": "thumbnailFormatPng"
  }

proc thumbnailFormatWebp*(): JsonNode = 
  result = %*{
    "@type": "thumbnailFormatWebp"
  }

proc thumbnailFormatGif*(): JsonNode = 
  result = %*{
    "@type": "thumbnailFormatGif"
  }

proc thumbnailFormatTgs*(): JsonNode = 
  result = %*{
    "@type": "thumbnailFormatTgs"
  }

proc thumbnailFormatMpeg4*(): JsonNode = 
  result = %*{
...
proc messageInteractionInfo*(viewCount: int32, forwardCount: int32, replyInfo = none(MessageReplyInfo)): JsonNode = 
  result = %*{
...
proc countryInfo*(countryCode: string, name: string, englishName: string, isHidden: bool, callingCodes: seq[string]): JsonNode = 
  result = %*{
    "@type": "countryInfo",
    "country_code": countryCode,
    "name": name,
...
proc userFullInfo*(isBlocked: bool, canBeCalled: bool, supportsVideoCalls: bool, hasPrivateCalls: bool, needPhoneNumberPrivacyException: bool, bio: string, shareText: string, groupInCommonCount: int32, botInfo = none(BotInfo), photo = none(ChatPhoto)): JsonNode = 
  result = %*{
    "@type": "userFullInfo",
    "photo": photo,
    "is_blocked": isBlocked,
...
proc messageCopyOptions*(sendCopy: bool, replaceCaption: bool, newCaption: FormattedText): JsonNode = 
  result = %*{
...
proc updateMessageIsPinned*(chatId: int64, messageId: int64, isPinned: bool): JsonNode = 
  result = %*{
...
proc updateMessageInteractionInfo*(chatId: int64, messageId: int64, interactionInfo = none(MessageInteractionInfo)): JsonNode = 
  result = %*{
...
proc updateChatPhoto*(chatId: int64, photo = none(ChatPhotoInfo)): JsonNode = 
  result = %*{
...
proc updateChatLastMessage*(chatId: int64, positions: seq[ChatPosition], lastMessage = none(Message)): JsonNode = 
  result = %*{
...
proc updateChatPosition*(chatId: int64, position: ChatPosition): JsonNode = 
  result = %*{
...
proc updateChatIsBlocked*(chatId: int64, isBlocked: bool): JsonNode = 
  result = %*{
...
proc updateChatDraftMessage*(chatId: int64, positions: seq[ChatPosition], draftMessage = none(DraftMessage)): JsonNode = 
  result = %*{
...
proc updateChatFilters*(chatFilters: seq[ChatFilterInfo]): JsonNode = 
  result = %*{
...
proc updateUserChatAction*(chatId: int64, messageThreadId: int64, userId: int32, action: ChatAction): JsonNode = 
  result = %*{
...
proc updateNewCallSignalingData*(callId: int32, data: string): JsonNode = 
  result = %*{
...
proc updateStickerSet*(stickerSet: StickerSet): JsonNode = 
  result = %*{
...
proc updateDiceEmojis*(emojis: seq[string]): JsonNode = 
  result = %*{
    "@type": "updateDiceEmojis",
    "emojis": emojis
  }

proc updateAnimationSearchParameters*(provider: string, emojis: seq[string]): JsonNode = 
  result = %*{
...
proc updateSuggestedActions*(addedActions: seq[SuggestedAction], removedActions: seq[SuggestedAction]): JsonNode = 
  result = %*{
...
proc callStateReady*(protocol: CallProtocol, servers: seq[CallServer], config: string, encryptionKey: string, emojis: seq[string], allowP2p: bool): JsonNode = 
  result = %*{
    "@type": "callStateReady",
    "protocol": protocol,
    "servers": servers,
...
proc notificationTypeNewPushMessage*(messageId: int64, sender: MessageSender, senderName: string, isOutgoing: bool, content: PushMessageContent): JsonNode = 
  result = %*{
...
proc statisticalValue*(value: float, previousValue: float, growthRatePercentage: float): JsonNode = 
  result = %*{
...
proc chatFilterInfo*(id: int32, title: string, iconName: string): JsonNode = 
  result = %*{
    "@type": "chatFilterInfo",
    "id": id,
    "title": title,
...
proc pollTypeQuiz*(correctOptionId: int32, explanation: FormattedText): JsonNode = 
  result = %*{
    "@type": "pollTypeQuiz",
...
proc messageForwardInfo*(origin: MessageForwardOrigin, date: int32, publicServiceAnnouncementType: string, fromChatId: int64, fromMessageId: int64): JsonNode = 
  result = %*{
...
proc messageReplyInfo*(replyCount: int32, recentRepliers: seq[MessageSender], lastReadInboxMessageId: int64, lastReadOutboxMessageId: int64, lastMessageId: int64): JsonNode = 
  result = %*{
...
proc inlineKeyboardButtonTypeCallbackWithPassword*(data: string): JsonNode = 
  result = %*{
...
proc thumbnail*(format: ThumbnailFormat, width: int32, height: int32, file: File): JsonNode = 
  result = %*{
    "@type": "thumbnail",
    "format": format,
    "width": width,
...
proc video*(duration: int32, width: int32, height: int32, fileName: string, mimeType: string, hasStickers: bool, supportsStreaming: bool, video: File, thumbnail = none(Thumbnail), minithumbnail = none(Minithumbnail)): JsonNode = 
  result = %*{
    "@type": "video",
    "duration": duration,
    "width": width,
...
proc stickerSet*(id: string, title: string, name: string, isInstalled: bool, isArchived: bool, isOfficial: bool, isAnimated: bool, isMasks: bool, isViewed: bool, stickers: seq[Sticker], emojis: seq[Emojis], thumbnail = none(Thumbnail)): JsonNode = 
  result = %*{
    "@type": "stickerSet",
    "id": id,
    "title": title,
...
proc chatStatisticsAdministratorActionsInfo*(userId: int32, deletedMessageCount: int32, bannedUserCount: int32, restrictedUserCount: int32): JsonNode = 
  result = %*{
...
proc chats*(totalCount: int32, chatIds: seq[int64]): JsonNode = 
  result = %*{
    "@type": "chats",
    "total_count": totalCount,
    "chat_ids": chatIds
...
proc messageStatistics*(messageInteractionGraph: StatisticalGraph): JsonNode = 
  result = %*{
...
proc chatInviteLinkInfo*(chatId: int64, accessibleFor: int32, typ: ChatType, title: string, memberCount: int32, memberUserIds: seq[int32], isPublic: bool, photo = none(ChatPhotoInfo)): JsonNode = 
  result = %*{
...
proc logStreamFile*(path: string, maxFileSize: int64, redirectStderr: bool): JsonNode = 
  result = %*{
    "@type": "logStreamFile",
    "path": path,
...
proc chatPhoto*(id: string, addedDate: int32, sizes: seq[PhotoSize], animation = none(AnimatedChatPhoto), minithumbnail = none(Minithumbnail)): JsonNode = 
  result = %*{
    "@type": "chatPhoto",
    "id": id,
...
proc optionValueInteger*(value: string): JsonNode = 
  result = %*{
...
proc chatStatisticsMessageSenderInfo*(userId: int32, sentMessageCount: int32, averageCharacterCount: int32): JsonNode = 
  result = %*{
...
proc bankCardActionOpenUrl*(text: string, url: string): JsonNode = 
  result = %*{
...
proc callbackQueryPayloadDataWithPassword*(password: string, data: string): JsonNode = 
  result = %*{
...
proc location*(latitude: float, longitude: float, horizontalAccuracy: float): JsonNode = 
  result = %*{
    "@type": "location",
    "latitude": latitude,
    "longitude": longitude,
...
proc supergroupFullInfo*(description: string, memberCount: int32, administratorCount: int32, restrictedCount: int32, bannedCount: int32, linkedChatId: int64, slowModeDelay: int32, slowModeDelayExpiresIn: float, canGetMembers: bool, canSetUsername: bool, canSetStickerSet: bool, canSetLocation: bool, canGetStatistics: bool, isAllHistoryAvailable: bool, stickerSetId: string, inviteLink: string, upgradedFromBasicGroupId: int32, upgradedFromMaxMessageId: int64, location = none(ChatLocation), photo = none(ChatPhoto)): JsonNode = 
  result = %*{
...
proc photoSize*(typ: string, photo: File, width: int32, height: int32, progressiveSizes: seq[int32]): JsonNode = 
  result = %*{
    "@type": "photoSize",
    "type": typ,
    "photo": photo,
...
proc webPageInstantView*(pageBlocks: seq[PageBlock], viewCount: int32, version: int32, isRtl: bool, isFull: bool): JsonNode = 
  result = %*{
...
proc messageLinkInfo*(isPublic: bool, chatId: int64, forAlbum: bool, forComment: bool, message = none(Message)): JsonNode = 
  result = %*{
...
proc chatLists*(chatLists: seq[ChatList]): JsonNode = 
  result = %*{
    "@type": "chatLists",
...
proc chatPosition*(list: ChatList, order: string, isPinned: bool, source = none(ChatSource)): JsonNode = 
  result = %*{
    "@type": "chatPosition",
    "list": list,
    "order": order,
...
proc profilePhoto*(id: string, small: File, big: File, hasAnimation: bool): JsonNode = 
  result = %*{
    "@type": "profilePhoto",
    "id": id,
    "small": small,
...
proc chatStatisticsMessageInteractionInfo*(messageId: int64, viewCount: int32, forwardCount: int32): JsonNode = 
  result = %*{
...
proc inlineQueryResultArticle*(id: string, url: string, hideUrl: bool, title: string, description: string, thumbnail = none(Thumbnail)): JsonNode = 
  result = %*{
...
proc inlineQueryResultContact*(id: string, contact: Contact, thumbnail = none(Thumbnail)): JsonNode = 
  result = %*{
...
proc inlineQueryResultLocation*(id: string, location: Location, title: string, thumbnail = none(Thumbnail)): JsonNode = 
  result = %*{
...
proc inlineQueryResultVenue*(id: string, venue: Venue, thumbnail = none(Thumbnail)): JsonNode = 
  result = %*{
...
proc chatStatisticsChannel*(period: DateRange, memberCount: StatisticalValue, meanViewCount: StatisticalValue, meanShareCount: StatisticalValue, enabledNotificationsPercentage: float, memberCountGraph: StatisticalGraph, joinGraph: StatisticalGraph, muteGraph: StatisticalGraph, viewCountByHourGraph: StatisticalGraph, viewCountBySourceGraph: StatisticalGraph, joinBySourceGraph: StatisticalGraph, languageGraph: StatisticalGraph, messageInteractionGraph: StatisticalGraph, instantViewInteractionGraph: StatisticalGraph, recentMessageInteractions: seq[ChatStatisticsMessageInteractionInfo]): JsonNode = 
  result = %*{
...
proc chatActionBarReportSpam*(canUnarchive: bool): JsonNode = 
  result = %*{
...
proc chatActionBarReportAddBlock*(canUnarchive: bool, distance: int32): JsonNode = 
  result = %*{
...
proc document*(fileName: string, mimeType: string, document: File, thumbnail = none(Thumbnail), minithumbnail = none(Minithumbnail)): JsonNode = 
  result = %*{
    "@type": "document",
    "file_name": fileName,
    "mime_type": mimeType,
...
proc chatPhotoInfo*(small: File, big: File, hasAnimation: bool): JsonNode = 
  result = %*{
    "@type": "chatPhotoInfo",
    "small": small,
    "big": big,
...
proc inputChatPhotoPrevious*(chatPhotoId: string): JsonNode = 
  result = %*{
    "@type": "inputChatPhotoPrevious",
    "chat_photo_id": chatPhotoId
  }

proc inputChatPhotoStatic*(photo: InputFile): JsonNode = 
  result = %*{
    "@type": "inputChatPhotoStatic",
    "photo": photo
  }

proc inputChatPhotoAnimation*(animation: InputFile, mainFrameTimestamp: float): JsonNode = 
  result = %*{
...
proc audio*(duration: int32, title: string, performer: string, fileName: string, mimeType: string, audio: File, albumCoverThumbnail = none(Thumbnail), albumCoverMinithumbnail = none(Minithumbnail)): JsonNode = 
  result = %*{
    "@type": "audio",
    "duration": duration,
    "title": title,
...
proc videoNote*(duration: int32, length: int32, video: File, thumbnail = none(Thumbnail), minithumbnail = none(Minithumbnail)): JsonNode = 
  result = %*{
    "@type": "videoNote",
    "duration": duration,
    "length": length,
...
proc callProblemDistortedVideo*(): JsonNode = 
  result = %*{
    "@type": "callProblemDistortedVideo"
  }

proc callProblemPixelatedVideo*(): JsonNode = 
  result = %*{
...
proc supergroupMembersFilterMention*(query: string, messageThreadId: int64): JsonNode = 
  result = %*{
...
proc inputMessageAnimation*(animation: InputFile, thumbnail: InputThumbnail, addedStickerFileIds: seq[int32], duration: int32, width: int32, height: int32, caption: FormattedText): JsonNode = 
  result = %*{
...
proc inputMessageDocument*(document: InputFile, thumbnail: InputThumbnail, disableContentTypeDetection: bool, caption: FormattedText): JsonNode = 
  result = %*{
...
proc inputMessageLocation*(location: Location, livePeriod: int32, heading: int32, proximityAlertRadius: int32): JsonNode = 
  result = %*{
...
proc inputMessageDice*(emoji: string, clearDraft: bool): JsonNode = 
  result = %*{
...
proc inputMessagePoll*(question: string, options: seq[string], isAnonymous: bool, typ: PollType, openPeriod: int32, closeDate: int32, isClosed: bool): JsonNode = 
  result = %*{
...
proc inputMessageForwarded*(fromChatId: int64, messageId: int64, inGameShare: bool, copyOptions: MessageCopyOptions): JsonNode = 
  result = %*{
...
proc callProtocol*(udpP2p: bool, udpReflector: bool, minLayer: int32, maxLayer: int32, libraryVersions: seq[string]): JsonNode = 
  result = %*{
    "@type": "callProtocol",
    "udp_p2p": udpP2p,
...
proc richTextReference*(text: RichText, anchorName: string, url: string): JsonNode = 
  result = %*{
...
proc richTextAnchor*(name: string): JsonNode = 
  result = %*{
    "@type": "richTextAnchor",
    "name": name
  }

proc richTextAnchorLink*(text: RichText, anchorName: string, url: string): JsonNode = 
  result = %*{
...
proc messageSendOptions*(disableNotification: bool, fromBackground: bool, schedulingState: MessageSchedulingState): JsonNode = 
  result = %*{
...
proc pageBlockChatLink*(title: string, username: string, photo = none(ChatPhotoInfo)): JsonNode = 
  result = %*{
...
proc dateRange*(startDate: int32, endDate: int32): JsonNode = 
  result = %*{
    "@type": "dateRange",
...
proc inputStickerStatic*(sticker: InputFile, emojis: string, maskPosition = none(MaskPosition)): JsonNode = 
  result = %*{
...
proc inputStickerAnimated*(sticker: InputFile, emojis: string): JsonNode = 
  result = %*{
